...
class CarlaGame():
    ...
    def __init__(self):
        ...
        # Set the desired fixed camera transform
        self.camera_transform = carla.Transform(carla.Location(x=1.1, z=1.8), carla.Rotation(pitch=-19.5))
    ...
    def reset_vehicle_position(self):
        ...
        # Set the transform for the cameras to the fixed one
        self.camera_rgb.set_transform(self.camera_transform)
        self.camera_semseg.set_transform(self.camera_transform)
